...
public class BoardServiceImpl implements BoardService {
	...
	@Override
	public Integer boardWrite(BoardDto boardDto, MultipartFile imageFile, MultipartFile uploadFile) throws Exception {
		
		if (imageFile != null && !imageFile.isEmpty()) {
			BFile bImgFile = new BFile();
			bImgFile.setDirectory(uploadPath);
			bImgFile.setName(imageFile.getOriginalFilename());
			bImgFile.setContentType(imageFile.getContentType());
			bImgFile.setSize(imageFile.getSize());
			fileRepository.save(bImgFile);
			
			File file = new File(uploadPath, bImgFile.getNum()+"");
