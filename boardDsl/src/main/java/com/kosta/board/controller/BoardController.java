...
public class BoardController {
	...
	public String boardWrite(BoardDto boardDto, 
							 ...
							 @RequestPart(value = "dfile", required = false) MultipartFile uploadFile, 
							 Model model) {
		try {
			Integer boardNum = boardService.boardWrite(boardDto, imageFile, uploadFile);
	...
	public String boardModify(BoardDto boardDto, 
		...
		try {
			...
			e.printStackTrace();
			model.addAttribute("err", "글 수정 오류");
			return "err";
		}
	}
